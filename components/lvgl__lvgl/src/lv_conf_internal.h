 ...
 *It removes the need to manually update the tick with `lv_tick_inc()`)*/
        ...
        #else
            #define LV_TICK_CUSTOM_INCLUDE "esp_timer"         /*Header for the system time function*/
        #endif
    #endif
        ...
        #else
           #define LV_TICK_CUSTOM_SYS_TIME_EXPR (esp_timer_get_time() / 1000) /* Expression for system time in ms */
        #endif
    #endif
